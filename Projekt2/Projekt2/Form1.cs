...
namespace Projekt2
{ 
    public partial class Flappy_Bird_Windows_Form : Form
    {
                 
        int pipeSpeed = 20; 
        int gravity = 5; 
        int score = 0; 
        public Flappy_Bird_Windows_Form()
        {
            InitializeComponent();
        }
        ...
        {                                                                            
            ...
            {
                // wenn leerzeichen gedrückt wird, wird die gravtation auf -5 gesetzt
                gravity = -5;
            }
        ...
        private void endGame()
        {
            ...
            scoreText.Text += "   MASON Game over!!!"; // show the game over text on the score text, += is used to add the new string of text next to the score instead of overriding it
        }
